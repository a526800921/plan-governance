...
同日 [Codex 单目标同步调整](plans/plan-governance-workflow-streamlining.md#codex-单目标同步调整2026-09-19)已完成源码实施：`setup` 移除 Claude/all 命名目标，独立发现的重复参数与混合 help 绕过已修复自验；该增量尚未发布或安装。
